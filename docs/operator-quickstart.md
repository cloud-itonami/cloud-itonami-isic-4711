# Operator Quickstart — Community Retail Operations

Shortest path from clone to a verified local dry-run for **ISIC 4711** (`cloud-itonami-isic-4711`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4711.git
cd cloud-itonami-isic-4711
```
...
- Likely source path: `retailops.governor.cljc`
